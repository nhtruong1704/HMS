...
if (strlen($EmployeeName) > 0 && strlen($EmployeePosition) > 0 && strlen($EmployeeSalary) > 0 && strlen($EmployeePhone) > 0 && strlen($EmployeeId) > 0) {
    ...
    if ($data) {
        if($EmployeeCurrentAvatar != "NO_CURRENT_IMAGE_EMPLOYEE_UPDATE") {
