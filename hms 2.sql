...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 19, 2023 lúc 02:55 PM
...
(14, 'what truong', '4665164', 'asdfasdgsadg', 'sadfsadfa@mail.com', 0, '123456', '05/18/2023', 0, 'NO_IMAGE_ADD_CUSTOMER');
...
CREATE TABLE `employee` (
  ...
  `employeeCurrentImage` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `employee` (`employeeId`, `employeeName`, `employeePosition`, `employeeSalary`, `employeePhone`, `employeeImage`, `employeeCurrentImage`) VALUES
...
--
ALTER TABLE `employee`
  MODIFY `employeeId` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
